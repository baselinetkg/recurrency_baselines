""" 
methods that are needed to apply the baselines psi and xi on the given test triples
this file has been modified by authors of this paper
originally from TLogic https://github.com/liu-yushan/TLogic/blob/main/mycode/rule_application.py but heavily modified
"""
