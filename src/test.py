...
and store a pkl file with predicted scores for each node for each test triple to results/baselinename.
It is possible to specify dataset, which baselines to use, and whether to use fixed or learned parameters in args
'''
